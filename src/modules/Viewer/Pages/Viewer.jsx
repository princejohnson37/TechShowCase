...
const Viewer = () => {
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", height: "95vh", marginTop: "7vh" }}>
        <div
          style={{
            width: "20%",
            borderRight: "solid",
        ...
        >
          ...
          <div>
            <Button label="live share" icon="pi pi-share-alt" iconPos="left" onClick={() => setShareModalVisibility(true)}/>
          </div>
        </div>
        <div
          style={{
      ...
      <ShareModal visible={shareModalVisibility} setVisible={setShareModalVisibility} projectId={projectId}/>
    </>
  );
};
